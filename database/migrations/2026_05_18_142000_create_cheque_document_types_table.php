...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (Schema::hasTable('cheque_document_types') && DB::table('cheque_document_types')->count() === 0) {
            $defaults = [
                ['key' => 'cheque_scan', 'label' => 'Cheque Scan', 'type' => 'single', 'display_order' => 0, 'is_active' => true],
                ['key' => 'supporting_doc', 'label' => 'Supporting Document', 'type' => 'single', 'display_order' => 1, 'is_active' => true],
            ];
