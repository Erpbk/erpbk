...
@section('title', 'SIM Company Ledger')
@section('content')
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3>{{ $simCompany->name }} <small class="text-muted">Ledger</small></h3>
            </div>
            <div class="col-sm-6 text-end">
                <a href="{{ route('simCompanies.show', $simCompany->id) }}" class="btn btn-outline-secondary">
                    <i class="ti ti-arrow-left me-1"></i> Back to company
                </a>
            </div>
        </div>
    </div>
