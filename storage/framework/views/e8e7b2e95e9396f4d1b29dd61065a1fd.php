...
<?php $__env->startSection('title', 'Import RTA Fines'); ?>
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a class="btn btn-primary float-right action-btn" href="<?php echo e(route('rtaFines.tickets', $account->id)); ?>" style="color: white; background-color: #007bff;">
                    Back to Fine List
                </a>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="salikImportForm" action="<?php echo e(route('rtaFines.import')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">Upload Excel file with RTA Fines data</small>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        var failedFines = results.failed_fines || [];
                        var importedFines = results.imported_ids || [];
                        ...
                        resultsHtml += '    <a href="<?php echo e(route('rtaFines.tickets', $account->id)); ?>" class="btn btn-primary">';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\erpbk\resources\views/rta_fines/import.blade.php ENDPATH**/ ?>