    ...
    <div class="card">
        <div class="card-body">
            <dl class="row mb-0">
                ...
                <dd class="col-sm-9">{{ $simCompany->name }}</dd>
                <dt class="col-sm-3">Company contact</dt>
                <dd class="col-sm-9">{{ $simCompany->company_contact ?: '—' }}</dd>
                <dt class="col-sm-3">Email</dt>
                <dd class="col-sm-9">{{ $simCompany->email ?: '—' }}</dd>
                <dt class="col-sm-3">Address</dt>
                <dd class="col-sm-9">{{ $simCompany->address ?: '—' }}</dd>
