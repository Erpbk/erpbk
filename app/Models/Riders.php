...
class Riders extends Model
{
  ...
  public static array $rules = [
    ...
    'personal_email' => 'required|string|max:191|unique:riders,personal_email',
    ...
    'emirate_id' => 'required|string|max:191|unique:riders,emirate_id',
    ...
    'dob' => 'nullable',
    'license_no' => 'required|string|max:191|unique:riders,license_no',
    ...
    'person_code' => 'nullable|string|max:50|unique:riders,person_code',
    'labor_card_number' => 'nullable|string|max:100|unique:riders,labor_card_number',
