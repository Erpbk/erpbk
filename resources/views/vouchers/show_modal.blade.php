...
<div class="voucher-modal-content">
  ...
  <div class="row g-3 mb-3 no-print">
    <div class="col-md-4">
      <hr class="my-0"><span class="small text-muted">Authorized Signature</span>
    </div>
    <div class="col-md-4">
      <hr class="my-0"><span class="small text-muted">Accountant Signature</span>
    </div>
    <div class="col-md-4">
      <hr class="my-0"><span class="small text-muted">Customer Signature</span>
    </div>
  </div>
