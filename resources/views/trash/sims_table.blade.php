<table class="table table-striped dataTable no-footer" id="dataTableBuilder">
   <thead class="text-center">
      <tr role="row">
         <th title="Number" class="sorting" tabindex="0" rowspan="1" colspan="1">Number</th>
         <th title="Company" class="sorting" tabindex="0" rowspan="1" colspan="1">Company</th>
         <th title="EMI" class="sorting" tabindex="0" rowspan="1" colspan="1">EMI</th>
         ...
         <th title="Vendor" class="sorting" tabindex="0" rowspan="1" colspan="1">Vendor</th>
      ...
      <tr>
         <td colspan="9" class="text-center">
            <div class="py-4">
               ...
               <p class="text-muted mb-0">No deleted SIMs found</p>
            </div>
         </td>
      </tr>
      @endif
