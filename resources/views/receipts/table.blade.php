...
<table class="table table-striped dataTable no-footer mt-3" id="dataTableBuilder">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                {{ $receipt->payer->account_code . '-' . $receipt->payer->name}}
            </td>
            <td>
            ...
            <td style="position: relative;">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="actiondropdown_{{ $receipt->id }}" style="z-index: 1050;">
                    ...
                    @endcan
                    @can('bank_edit')
                        <a href="javascript:void(0);" class='dropdown-item waves-effect show-modal' data-size="lg" data-title="Update Receipt Details" data-action="{{ route('receipts.edit', $receipt->id) }}">
