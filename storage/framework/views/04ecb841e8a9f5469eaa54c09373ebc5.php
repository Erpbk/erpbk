<?php $__env->startSection('title','Rider Live Activities'); ?>
...
<div class="row mb-2">
  <div id="filterSidebar" class="filter-sidebar" style="z-index: 1111;">
    ...
    <div class="filter-body" id="searchTopbody">
      <form id="filterForm" action="<?php echo e(route('rider.liveactivities')); ?>" method="GET">
        <div class="row">
          <div class="form-group col-md-12">
            ...
            <select class="form-control" id="id" name="id">
              ...
              <option value="<?php echo e($rider->rider_id); ?>" <?php echo e(request('id') == $rider->rider_id ? 'selected' : ''); ?>>
  ...
  <div class="card h-100" style="border-radius: 0px !important;">
    <div class="card-header d-flex justify-content-between">
      ...
      <small class="text-body-secondary">
        <a class="btn btn-primary show-modal mx-2" href="javascript:void(0);" data-size="sm" data-title="Import Rider Activities" data-action="<?php echo e(route('rider.live_activities_import')); ?>"> <i class="ti ti-activity"></i> Import Live Activities</a>
...
<div class="content">
  ...
  <div class="card" style="border-radius: 0px !important;">
    <div class="card-body table-responsive px-2 py-0" id="table-data">
      <?php echo $__env->make('rider_live_activities.table', ['data' => $data], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
  </div>
</div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#filterForm').on('submit', function(e) {
      ...
      $.ajax({
        url: "<?php echo e(route('rider.liveactivities')); ?>",
        type: "GET",
        data: formData,
        success: function(data) {
          ...
          // Update URL
          let newUrl = "<?php echo e(route('rider.liveactivities')); ?>" + (formData ? '?' + formData : '');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xammp1\htdocs\erpbk\resources\views/rider_live_activities/index.blade.php ENDPATH**/ ?>