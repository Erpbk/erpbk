...
<body style="">
    <div style="position: relative;min-height: 100%;height: 100%;">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($voucher)): ?>
        <table width="100%" style="font-family: sans-serif; margin-top: 20px;font-size: 12px">
            ...
            <tr>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($voucher->billing_month)): ?>
        ...
        <table style="width: 100%; font-family: sans-serif;text-align: left;border: 1px solid #000; border-collapse: collapse; margin-top: 20px;font-size: 12px;">
            ...
            <tbody>
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $voucher->transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($voucher->voucher_type == 'RFV'): ?>
                    <td style="padding: 5px;border:1px solid;text-align: left"><?php echo e($item->narration); ?>

                        <b>Ticket No:</b><?php echo e($fin_detail->ticket_no ?? ''); ?>,<b>Bike No:</b><?php echo e($fin_detail->plate_no ?? ''); ?>, <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($fin_detail && $fin_detail->trip_date): ?> <?php echo e(\Carbon\Carbon::parse($fin_detail->trip_date)->format('d M Y')); ?> <?php else: ?> N/A <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </td>
                    <?php else: ?>
...
</html><?php /**PATH C:\xampp\htdocs\erpbk\resources\views/vouchers/show_fields.blade.php ENDPATH**/ ?>