<table class="table table-striped dataTable no-footer" id="dataTableBuilder">
   <thead class="text-center">
      <tr role="row">
         ...
         <th title="Ticket No" class="sorting" tabindex="0" rowspan="1" colspan="1">Ticket No</th>
         <th title="Voucher No" class="sorting" tabindex="0" rowspan="1" colspan="1">Voucher No</th>
         <th title="Rider Id" class="sorting" tabindex="0" rowspan="1" colspan="1">Rider Id</th>
         <th title="Rider" class="sorting" tabindex="0" rowspan="1" colspan="1">Rider</th>
         ...
         <th title="Total Amount" class="sorting" tabindex="0" rowspan="1" colspan="1">Total Amount</th>
      ...
      <tr>
         <td colspan="13" class="text-center">
            <div class="py-4">
               ...
               <p class="text-muted mb-0">No deleted RTA fines found</p>
            </div>
         </td>
      </tr>
      @endif
