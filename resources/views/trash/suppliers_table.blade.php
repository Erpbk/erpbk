<table class="table table-striped dataTable no-footer" id="dataTableBuilder">
   <thead class="text-center">
      <tr role="row">
         ...
         <th title="Phone" class="sorting" tabindex="0" rowspan="1" colspan="1">Phone</th>
         <th title="Company Name" class="sorting" tabindex="0" rowspan="1" colspan="1">Company Name</th>
         <th title="Address" class="sorting" tabindex="0" rowspan="1" colspan="1">Address</th>
      ...
      <tr>
         <td colspan="7" class="text-center">
            <div class="py-4">
               ...
               <p class="text-muted mb-0">No deleted suppliers found</p>
            </div>
         </td>
      </tr>
      @endif
