...
{{-- Tabs: General | Voucher Types | Voucher Custom Fields --}}
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        <ul class="nav nav-tabs mb-3" id="voucherSettingsMainTabs" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="tab-voucher-types-btn" data-bs-toggle="tab" data-bs-target="#tab-voucher-types" type="button" role="tab">Voucher Types</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="tab-voucher-fields-btn" data-bs-toggle="tab" data-bs-target="#tab-voucher-fields" type="button" role="tab">Voucher Custom Fields</button>
          </li>
        </ul>

        <div class="tab-content" id="voucherSettingsTabContent">
          ...
          {{-- Tab 2: Voucher Types --}}
          <div class="tab-pane fade" id="tab-voucher-types" role="tabpanel">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
              <p class="text-muted small mb-0">Manage voucher types shown when creating a voucher.</p>
          ...
          {{-- Tab 3: Voucher Custom Fields --}}
          <div class="tab-pane fade" id="tab-voucher-fields" role="tabpanel">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
              <p class="text-muted small mb-0">Add and manage custom fields for vouchers.</p>
