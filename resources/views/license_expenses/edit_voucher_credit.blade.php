...
<div class="visa-edit-voucher-credit-modal">
    ...
    <div class="border-top pt-3 px-1">
        ...
        @else
        <form method="post" action="{{ route('LicenseExpense.updateVoucherCredit') }}" class="visa-voucher-credit-form">
            @csrf
            <input type="hidden" name="license_expense_id" value="{{ $expense->id }}">
            ...
            <div class="mb-3">
                ...
                <div class="form-text">Only the payment side changes; the License Expense debit line stays on the head account.</div>
            </div>
