...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('bike_registration_statuses')) {
            return;
        }

        Schema::create('bike_registration_statuses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('bike_registration_statuses');
    }
};
