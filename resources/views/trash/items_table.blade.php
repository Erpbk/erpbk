<table class="table table-striped dataTable no-footer" id="dataTableBuilder">
   <thead class="text-center">
      <tr role="row">
         ...
         <th title="Supplier" class="sorting" tabindex="0" rowspan="1" colspan="1">Supplier</th>
         <th title="Price" class="sorting" tabindex="0" rowspan="1" colspan="1">Price</th>
         <th title="Vat" class="sorting" tabindex="0" rowspan="1" colspan="1">Vat</th>
