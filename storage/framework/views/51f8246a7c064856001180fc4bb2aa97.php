...
<div class="form-group col-sm-6">
    ...
    <select class="form select select2" required onchange="selectbike(this.value)" id="bike_id" name="bike_id">
        <option value=""></option>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = DB::table('bikes')->where('status', 1)->orderBy('id', 'desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
...
<div class="form-group col-sm-6">
    ...
    <select class="form select select2" required id="debit_account" name="debit_account">
        <option value=""></option>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($rtaFines)): ?>
        <?php
...
<div class="form-group col-sm-6">
    ...
    <select class="form select select2" required id="rta_account_id" name="rta_account_id">
        <option value=""></option>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = DB::table('accounts')->where('status' , 1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</script><?php /**PATH C:\xampp\htdocs\erpbk\resources\views/rta_fines/fields.blade.php ENDPATH**/ ?>