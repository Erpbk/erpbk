...
<div class="form-group col-sm-4 mt-3">
    ...
    <div class="form-check">
        ...
        <input type="checkbox" name="status" id="status" class="form-check-input" value="1" @isset($fuelCompany) @if($fuelCompany->status == 1) checked @endif @else checked @endisset/>
