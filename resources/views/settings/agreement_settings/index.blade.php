        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade {{ $activeTab === 'letterhead' ? 'show active' : '' }}" id="tab-letterhead" role="tabpanel">
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-3">
              <div>
                ...
                <p class="text-muted small mb-0">
                  Upload full-page designs (JPG, PNG, WebP, or PDF). Each agreement can then pick one of these, or keep the default company logo header.
                </p>
              </div>
            </div>
            ...
            <form method="POST" action="{{ route('settings-panel.agreement-letterheads.store', ['company_slug' => $companySlug]) }}" enctype="multipart/form-data" class="border rounded p-3 mb-4 bg-light">
              ...
              <div class="row g-2 align-items-end">
                <div class="col-md-4">
                  ...
                  <input type="text" name="name" class="form-control form-control-sm" value="{{ old('name') }}" placeholder="e.g. Stellar Innovations">
                </div>
                <div class="col-md-5">
            ...
            <div class="row g-3">
              ...
              @empty
              <div class="col-12">
                <p class="text-muted mb-0">No letterheads uploaded yet. Agreements will use the company logo and contact details until you add one.</p>
              </div>
              @endforelse
            </div>
          </div>
