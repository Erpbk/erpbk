<form action="{{ route('employeeInvoices.markAsSettled', $invoice->id) }}" method="POST" id="formajax">
    @csrf
    <div class="card-body">
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <table class="table table-sm table-borderless mb-0">
                    ...
                    <tr>
                        <td class="ps-0"><strong>Employee:</strong></td>
                        <td>{{ ($invoice->employee->employee_id ?? '-') }} - {{ ($invoice->employee->name ?? '-') }}</td>
                    </tr>
                </table>
            </div>
            <div class="col-md-6">
