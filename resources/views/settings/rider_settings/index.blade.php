                ...
                <div class="table-responsive">
                  <table class="table table-hover rider-settings-table mb-0">
                    ...
                    <tbody id="rider-fields-tbody-all">
                      ...
                      @empty
                      <tr>
                        <td colspan="5" class="text-center text-muted py-3">No rider fields found.</td>
                      </tr>
                      @endforelse
...
<script>
  (function() {
    ...
    document.addEventListener('click', function(e) {
      ...
      var visibleHidden = document.getElementById('editRiderFixedFieldVisibleHidden');
      ...
      if (visibleHidden) visibleHidden.value = String(isVisible) === '1' ? '1' : '0';
