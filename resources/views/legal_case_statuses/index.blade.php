...
@section('content')
@php $legalCaseRoute = $legalCaseRoute ?? ((View::shared('settings_panel') ?? false) ? 'settings-panel.legal-case-statuses' : 'legal-case-statuses'); @endphp
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <a class="btn btn-primary float-end" href="{{ route($legalCaseRoute . '.create') }}">
                    Add New Status
                </a>
                @endcan
            </div>
...
<div class="content px-3">
    ...
    <div class="card">
        ...
        <div class="card-body table-responsive px-2 py-0" id="table-data">
            @include('legal_case_statuses.table', ['legalCaseStatuses' => $legalCaseStatuses, 'legalCaseRoute' => $legalCaseRoute])
        </div>
    </div>
</div>
@endsection
...
<script type="text/javascript">
    ...
    function initSortable() {
        ...
        var reorderUrl = '{{ route($legalCaseRoute . ".reorder") }}';
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $(document).on('click', '.js-visa-status-delete-btn', function(e) {
            ...
            Swal.fire({
                ...
                deleteLegalCaseStatusAjax(deleteUrl, btn).catch(function(err) {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
