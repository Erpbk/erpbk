...
<table width="100%" style="font-family: sans-serif;">
    ...
    <tr style="text-align: center;">
        <td colspan="3">
            <h4 style="margin-bottom: 15px;margin-top: 25px;font-size: 14px;border-bottom: 1px solid #000;padding: 7px 0px;"> <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($voucher_type)): ?><?php echo e($voucher_type); ?><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></h4>
        </td>
    </tr>

</table><?php /**PATH C:\xampp\htdocs\erpbk\resources\views/_partials/header.blade.php ENDPATH**/ ?>