...
<form
  ...
  id="formajax"
  data-errors-route="<?php echo e($errorsRoute); ?>"
  data-success-message="<?php echo e($successMessage); ?>"
  data-summary='<?php echo json_encode($importSummary, 15, 512) ?>'
  data-validation-errors='<?php echo json_encode($validationErrors, 15, 512) ?>'>
  <?php echo csrf_field(); ?>
  <div class="row">
    <div class="col-12">
      <?php if(!empty($importTypeLabel)): ?>
      <h5 class="text-primary mb-3"><?php echo e($importTypeLabel); ?></h5>
      <?php endif; ?>
      <?php if(!empty($sampleDownloadUrl)): ?>
      <a href="<?php echo e($sampleDownloadUrl); ?>" class="text-success w-100" download="<?php echo e($sampleDownloadLabel ?? 'Rider Activities Sample'); ?>">
        <i class="fa fa-file-download text-success"></i> &nbsp; <?php echo e($sampleDownloadLabel ?? 'Download Sample File'); ?>
  ...
  <a href="<?php echo e($errorsRoute); ?>" class="btn btn-info" style="width: 100%; margin-top: 10px;">Check Last Import Errors</a>
</form>
...
</script><?php /**PATH D:\xammp1\htdocs\erpbk\resources\views/rider_live_activities/import.blade.php ENDPATH**/ ?>