{!! Form::open(['route' => ['bikeMaintenance.store'], 'method' => 'post', 'id' => 'formajax', 'files' => true]) !!}
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <div class="input-group">
                    ...
                    {!! Form::number('previous_km', $bike->previous_km ?? null, [
                        ...
                        'min' => '0',
                        'id' => 'previous_km',
                        'readonly' => !is_null($bike->previous_km)
                    ]) !!}
                </div>
            </div>
            ...
            {{-- Maintenance At --}}
            <div class="form-group col-md-3">
                {!! Form::label('maintenance_at', 'Maintenance At', ['class' => 'required']) !!}
                <div class="input-group">
                    <span class="input-group-text">KM</span>
                    {!! Form::number('maintenance_at',  null, [
                        'class' => 'form-control', 
                        'step' => 'any', 
                        'required' => true,
                        'min' => '0',
            ...
            <div class="form-group col-md-3">
                ...
                <div class="input-group">
                    <span class="input-group-text">KM</span>
                    {!! Form::number('current_km', $bike->current_km ?? null, [
                        'class' => 'form-control', 
                        'step' => 'any', 
                        'min' => '0',
                        'id' => 'current_km',
            ...
            <div class="form-group col-md-3">
                ...
                <div class="input-group">
                    ...
                    {!! Form::number('overdue_cost_per_km', null, [
                        'class' => 'form-control', 
                        'step' => '0.01', 
                        'required' => true,
                        'min' => '0',
            ...
            <div id="row-container">
                <div class="row">
                    ...
                    <div class="form-group col-md-1">
                        ...
                        {!! Form::number('discount[]', null, ['class' => 'form-control discount', 'step' => 'any']) !!}
                    </div>
                    <div class="form-group col-md-1">
                        {!! Form::label('vat', 'VAT') !!}
                        {!! Form::number('vat[]', null, ['class' => 'form-control vat', 'step' => 'any']) !!}
                    </div>
                    <div class="form-group col-md-2">
                        {!! Form::label('amount', 'Total Amount') !!}
                        {!! Form::number('item_total[]', null, ['class' => 'form-control item_total', 'step' => 'any', 'readonly' =>true]) !!}
                    </div>
                    <div class="form-group col-md-1">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        ...
                        <select name="item_id[]" class="form-control select2 item">
                            ...
                            <option data-price="{{ $item->price }}" value="{{ $i->id }}" @if($i->id === $item->id) selected @endif>{{ $i->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-md-2">
                        {!! Form::label('qty', 'Qty') !!}
                        {!! Form::number('quantity[]', $item->qauntity ?? null, ['class' => 'form-control qty']) !!}
                    </div>
                    <div class="form-group col-md-2">
                        {!! Form::label('rate', 'Rate') !!}
                    ...
                    <div class="form-group col-md-1">
                        {!! Form::label('vat', 'VAT') !!}
                        {!! Form::textarea('vat[]', $item->discount ?? null, ['class' => 'form-control vat', 'step' => 'any']) !!}
                    </div>
                    <div class="form-group col-md-2">
                        {!! Form::label('amount', 'Amount') !!}
                        {!! Form::number('item_total[]', $item->total, ['class' => 'form-control item_total', 'step' => 'any', 'readonly' => true]) !!}
                    </div>
                    @if($index == 0)
                        <div class="form-group col-md-1">
                        </div>
    ...
    <div class="d-flex justify-content-between align-items-center gap-3">
        ...
        <div class="d-flex align-items-center">
            <div class="input-group flex-nowrap">
                ...
                <input type="number" class="form-control" id="total_cost" readonly style="min-width: 120px;">
            </div>
        </div>
    </div>
