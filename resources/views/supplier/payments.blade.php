            ...
            <div class="action-buttons d-flex justify-content-end">
                <div class="action-dropdown-container">
                    ...
                    <div class="action-dropdown-menu" id="addBikeDropdown">
                        <a class="action-dropdown-item show-modal" href="javascript:void(0);" data-size="xl" data-title="Add New Payment (Cash Out)" data-action="{{ route('payments.create') }}?supplier_payment={{ true }}">
                            <i class="ti ti-plus"></i>
                            <div>
