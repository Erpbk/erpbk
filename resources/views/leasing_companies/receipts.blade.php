    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                ...
                @can('receipt_create')
                    <button class="btn btn-primary btn-sm show-modal" href="javascript:void(0);" data-size="xl" data-title="Add New Receipt" data-action="{{ route('receipts.create') }}?leasing_company_id={{ $leasingCompany->id }}">Add New</button>
                @endcan
            </div>
                ...
                <table class="table table-striped dataTable no-footer mt-3" id="dataTableBuilder">
                    <thead class="text-center">
                        <tr role="row">
                            ...
                            <th title="Leasing Company" class="sorting" tabindex="0" aria-controls="dataTableBuilder" rowspan="1" colspan="1" aria-label="Leasing Company: activate to sort column ascending">Receiver</th>
