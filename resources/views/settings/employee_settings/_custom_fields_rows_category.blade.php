@forelse($customFields as $index => $field)
  <tr data-id="{{ $field->id }}">
    ...
    <td class="align-middle employee-custom-field-index">{{ $index + 1 }}</td>
    <td class="align-middle">
      {{ $field->label }}
      @if($field->help_text)
      ...
      <div class="btn-group btn-group-sm" role="group">
        <button type="button"
                ...
                onclick="
                  ...
                  var prevCat = document.getElementById('editEmployeeFieldPreviousCategoryId');
        ...
        <form method="POST"
          ...
          @csrf
          @method('DELETE')
          <button type="submit" class="btn btn-outline-danger btn-icon btn-destroy-employee-field">
