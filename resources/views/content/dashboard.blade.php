      ...
      <div class="card-body">
        <a href="{{ route('vendors.index') }}">
          <div class="d-flex align-items-center mb-2 pb-1">
            ...
            <h4 class="ms-1 mb-0">{{ company_table('vendors')->where('company_id', auth()->user()->company_id)->where('status' , 1)->get()->count() }}</h4>
          </div>
      ...
      <div class="card-body">
        <a href="{{ route('vendors.index') }}">
          <div class="d-flex align-items-center mb-2 pb-1">
            ...
            <h4 class="ms-1 mb-0">{{ company_table('vendors')->where('company_id', auth()->user()->company_id)->where('status' , 2)->get()->count() }}</h4>
          </div>
          <a href="" class="text-dark">
      ...
      <div class="card-body">
        <a href="{{ route('riders.index') }}">
          <div class="d-flex align-items-center mb-2 pb-1">
            ...
            <h4 class="ms-1 mb-0">{{ company_table('riders')->where('company_id', auth()->user()->company_id)->get()->count() }}</h4>
          </div>
          <a href="" class="text-dark">
      ...
      <div class="card-body">
        <a href="{{ route('bikes.index') }}">
          <div class="d-flex align-items-center mb-2 pb-1">
            ...
            <h4 class="ms-1 mb-0">{{ company_table('bikes')->where('company_id', auth()->user()->company_id)->get()->count() }}</h4>
          </div>
          <a href="" class="text-dark">
      ...
      <div class="card-body">
        <a href="{{ route('sims.index') }}">
          <div class="d-flex align-items-center mb-2 pb-1">
            ...
            <h4 class="ms-1 mb-0">{{ company_table('sims')->where('company_id', auth()->user()->company_id)->get()->count() }}</h4>
          </div>
          <a href="" class="text-dark">
            <p class="mb-1">Sims</p>
          </a>
