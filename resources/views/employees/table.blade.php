<table class="table" id="dataTableBuilder">
    <thead>
        <tr>
            <th>{{ $employeeTableLabels['employee_id'] ?? 'Employee ID' }}</th>
            <th>{{ $employeeTableLabels['name'] ?? 'Name' }}</th>
            <th>{{ $employeeTableLabels['company_contact'] ?? 'Contact' }}</th>
            <th>{{ $employeeTableLabels['branch_id'] ?? 'Branch' }}</th>
            <th>{{ $employeeTableLabels['department_id'] ?? 'Department' }}</th>
            <th>{{ $employeeTableLabels['designation'] ?? 'Designation' }}</th>
            <th>{{ $employeeTableLabels['doj'] ?? 'Date of Joining' }}</th>
            <th>{{ $employeeTableLabels['documents_expiry'] ?? 'Documents Expiry' }}</th>
            <th>{{ $employeeTableLabels['status'] ?? 'Status' }}</th>
            <th>{{ $employeeTableLabels['actions'] ?? 'Actions' }}</th>
        </tr>
    </thead>
    <tbody>
