...
<div class="container-fluid">
  ...
  <div class="imp-page-header d-flex align-items-center gap-3">
    <a href="{{ route('rider.liveactivities') }}" class="imp-back-btn" title="Back to Live Activities">
      <i class="ti ti-arrow-left" style="font-size:1.1rem;"></i>
    </a>
    <div>
      <h1 class="imp-title">
        <i class="ti ti-live-photo" style="color:#16a34a;margin-right:.3rem;"></i>
        Import Live Activities
      </h1>
      <p class="imp-subtitle">Upload an Excel or CSV file to bulk-import live activity records.</p>
    </div>
  ...
  <div class="imp-card">
    ...
    <div class="imp-info-banner mb-4">
      ...
      <span>
        ...
        <a href="{{ url('sample/live_activity_sample.xlsx') }}" class="font-weight-bold ml-1" download="Live Activities Sample">
    ...
    <form
      action="{{ route('rider.live_activities_import_page') }}"
      method="POST"
      enctype="multipart/form-data"
      id="live-activities-import-page-form">
      @csrf
...
@include('rider_activities.partials.import_ajax_script', [
  'formId' => 'live-activities-import-page-form',
