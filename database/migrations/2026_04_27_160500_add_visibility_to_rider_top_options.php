...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('rider_top_options', function (Blueprint $table) {
            if (!Schema::hasColumn('rider_top_options', 'show_in_top_bar')) {
                $table->boolean('show_in_top_bar')->default(true)->after('is_active');
            }
            if (!Schema::hasColumn('rider_top_options', 'show_in_view_cards')) {
