            ...
            <td>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="actiondropdown" style="">
                        <a href="<?php echo e(route('salik.tickets', $r->id)); ?>" class="dropdown-item waves-effect">
                            View
                        </a>
                        <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#editaccount<?php echo e($r->id); ?>"  class='dropdown-item waves-effect show-modal'>
                            Edit
                        </a>
                        <a href="javascript:void(0);" onclick='confirmDelete("<?php echo e(route('salik.deleteaccount', $r->id)); ?>")' class='dropdown-item confirm-modal' data-size="lg" data-title="Delete Account">
                            Delete
                        </a>
                    </div>
                </div>
