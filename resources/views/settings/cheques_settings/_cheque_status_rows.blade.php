  ...
  <td class="align-middle text-center">
    <div class="form-check form-switch d-inline-block mb-0">
      <input type="checkbox"
        ...
        data-update-url="{{ route('settings-panel.cheques-settings.update-rider-status', ['id' => $statusOption->id]) }}"
  ...
  <td class="text-end align-middle">
    <div class="btn-group btn-group-sm" role="group">
      <button type="button"
        ...
        data-bs-target="#editchequeStatusModal">
        <i class="ti ti-edit"></i>
      </button>
      <form method="POST"
        action="{{ route('settings-panel.cheques-settings.destroy-rider-status', ['id' => $statusOption->id]) }}"
        class="d-inline"
...
@empty
<tr>
  <td colspan="5" class="text-center text-muted py-4">No Cheque Statuses configured yet.</td>
</tr>
@endforelse
