            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="GET" action="{{ route('rider.live_activities_import_errors') }}" class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <a href="{{ route('rider.live_activities_import_errors') }}" class="btn btn-secondary">
...
<script>
    ...
    function exportToExcel() {
        ...
        try {
            ...
            downloadLink.download = 'live_activities_import_report_' + new Date().getTime() + '.xls';
