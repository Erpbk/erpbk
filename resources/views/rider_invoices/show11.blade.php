text/x-generic show.blade.php ( HTML document, ASCII text, with very long lines )
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="invoice-box">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 8px;">
            ...
            <tr>
                ...
                <td style="border: 1px solid #000; padding: 4px 6px; width: 30%;" @if(in_array((int) ($riderInvoice->rider->status ?? 0), [3, 4, 5], true)) style="border: 1px solid #000; padding: 4px 6px; color:red;" @endif>{{ \App\Services\RiderInvoice\RiderInvoiceViewDataBuilder::riderStatusLabel($riderInvoice->rider->status ?? null) }}</td>
            </tr>
            <tr>
