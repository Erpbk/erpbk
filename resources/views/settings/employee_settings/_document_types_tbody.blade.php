  ...
  <tr data-id="{{ $doc->id }}">
    ...
    <td class="text-end align-middle">
      <div class="btn-group btn-group-sm" role="group">
        ...
        <form method="POST"
              action="{{ route('settings-panel.employee-settings.destroy-document-type', $doc->id) }}"
...
@empty
  <tr>
    <td colspan="6" class="text-center text-muted py-4">No document types yet. Add one to define required employee documents.</td>
  </tr>
@endforelse
